...
export const Cog = ({className, width, height, onClick}:InterfaceIcon) => {
    return (
        <
            svg xmlns="http://www.w3.org/2000/svg" 
            viewBox="0,0,256,256" 
            ...
            onClick={onClick}
        >
            <g fill="#66FCF1" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter"
                strokeMiterlimit="10"  strokeDashoffset="0">
...
export const PasswordIcon = ({className, width, height, onClick}:InterfaceIcon) => {
    return (
        <
            svg xmlns="http://www.w3.org/2000/svg" 
            viewBox="0,0,256,256" 
            ...
            onClick={onClick}
        >
            <g fill="#66fcf1" fillRule="nonzero" 
...
export const BackIcon = ({className, width, height, onClick}:InterfaceIcon) => {
    return (
        <svg 
            width={width}
            height={height}
